...
document.writeln("<\/ul>");
document.writeln("    <div id=\"skin\"><ul><li id=\"skin_homeblue\" class=\"selected\" title=\"\">蓝色<\/li>");
document.writeln("    <li id=\"skin_homered\"  title=\"\">红色<\/li>");
document.writeln("    <li id=\"skin_homegreen\" title=\"\">绿色<\/li>");
document.writeln("    <li id=\"skin_homegray\"  title=\"\">灰色<\/li><\/ul><\/div>")
