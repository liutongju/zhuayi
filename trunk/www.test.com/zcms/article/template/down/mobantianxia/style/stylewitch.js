...
var i, cacheobj
for(i=0; (cacheobj=document.getElementsByTagName("link")); i++) {
...
if (element.value==selectedtitle){ //if match found between form element value and cookie value
if (element.tagName=="OPTION") //if this is a select menu
